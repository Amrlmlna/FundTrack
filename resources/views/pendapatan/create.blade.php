            ...
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0 fw-bold">
                        <i class="bi bi-plus-circle me-2"></i>Tambah Pendapatan
                    </h4>
                </div>
                    ...
                    <form action="{{ route('pendapatan.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <select name="kategori_id" id="kategori_id" class="form-select form-select-lg" required>
                                <option value="" disabled selected>Pilih kategori pendapatan</option>
                        ...
                        <div class="mb-4">
                            ...
                            <textarea class="form-control" id="deskripsi" name="deskripsi" rows="3" placeholder="Masukkan deskripsi pendapatan"></textarea>
                        </div>

                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="bi bi-check-circle me-2"></i>Simpan Pendapatan
                            </button>
